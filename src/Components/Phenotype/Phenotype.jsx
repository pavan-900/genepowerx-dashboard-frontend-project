...
const Phenotype = ({ isPhenotypeVisible, selectedPatient, selectedBatch }) => {
  ...
  const fetchPDF = async (fileType) => {
    ...
    const url = `https://genepowerx-backend.onrender.com/patient_files/${selectedBatch}/${selectedPatient}/${fileType}`;
          ...
          >
            <Checkbox
              ...
              checked={dialogSelection.includes(
                `https://genepowerx-backend.onrender.com/patient_files/${selectedPatient}/${file.type}`
              )}
              onChange={() =>
